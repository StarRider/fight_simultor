...
training_set = train_datagen.flow_from_directory('fight_move_data/train',
                                                 target_size=(64, 64),
                                                 batch_size=10,
                                                 color_mode='grayscale',
                                                 class_mode='binary')

test_set = test_datagen.flow_from_directory('fight_move_data/test',
                                            target_size=(64, 64),
                                            batch_size=10,
                                            color_mode='grayscale',
                                            class_mode='binary')
...
with open("model-fight.json", "w") as json_file:
    json_file.write(model_json)
classifier.save_weights('model-fight.h5')
